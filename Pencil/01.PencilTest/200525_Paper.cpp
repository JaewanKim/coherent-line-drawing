...
//// 0701 : 이미 계산했던 거에 대해서는 수행하지 않는 걸로 수정
//
...
//}
//
//void recursive(Mat& ResultImg, Mat& FlagField, int leftX, int rightX, int topY, int bottomY, int jitteredValue) {
//
//    if (jitteredValue < 0)
//        jitteredValue = 0;
//
...
//    else {
//        recursive(ResultImg, FlagField, leftX, (leftX + rightX) / 2, topY, (topY + bottomY) / 2, jitteredValue - 1);     // jitteredValue - 1  //1
//        recursive(ResultImg, FlagField, leftX, (leftX + rightX) / 2, (topY + bottomY) / 2, bottomY, jitteredValue - 1);    // jitteredValue--
//        recursive(ResultImg, FlagField, (leftX + rightX) / 2, rightX, topY, (topY + bottomY) / 2, jitteredValue - 1);
//        recursive(ResultImg, FlagField, (leftX + rightX) / 2, rightX, (topY + bottomY) / 2, bottomY, jitteredValue - 1);
//    }
//}
//
//int main() {
//
//    //int n = 15;     // 9 + 7 (2^7 = 128)
//    for (int n = 10; n <= 15; n++) {
//
...
//
//                    printf("recur\n");
//                    recursive(ResultImg, FlagField, 0, width - 1, 0, height - 1, jittered);  
//
//                    printf("image\n");
//                    string saveFilePath = "D:\\lab\\ETF\\Output\\200702\\2dRecursivePaper(n=11-15)\\";
