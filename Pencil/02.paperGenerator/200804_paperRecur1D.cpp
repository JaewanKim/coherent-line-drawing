...
//}
//
//void paperRecur1D(Mat& ResultImg, int leftX, int rightX, int Y, int jitteredValue) {
//
//    if (jitteredValue < 0)
//        jitteredValue = 0;
//
//    int leftValue = ResultImg.at<unsigned char>(Y, leftX);
//    int rightValue = ResultImg.at<unsigned char>(Y, rightX);
//
//    //int newjitteredValue = getJitteredAlpha(jitteredValue);
//
//    int centerValue = (int((leftValue + rightValue) / 2)) + getJitteredAlpha(jitteredValue);
//    centerValue = checkRange(centerValue);
//
//    ResultImg.at<unsigned char>(Y, (leftX + rightX) / 2) = (unsigned char)centerValue;
//
//    if (leftX == rightX - 2) return;
//    else {
//        paperRecur1D(ResultImg, leftX, (leftX + rightX) / 2, Y, jitteredValue - 1);
//        paperRecur1D(ResultImg, (leftX + rightX) / 2, rightX, Y, jitteredValue - 1);
//    }
//}
//
//
...
//                    // init
//                    ResultImg.at<unsigned char>(j, 0) = randomRange(sideMin, sideMax);
//                    ResultImg.at<unsigned char>(j, width - 1) = randomRange(sideMin, sideMax);
//
//                    //printf("recur\n");
//                    paperRecur1D(ResultImg, 0, width - 1, j, jittered);
//                }
//
//
//                // 2d
